...
每帧使用 5 次正式重复的中位数。FDP 取 raw 深度；V5-original、BCM、R1、RM、R1F 取 LingBot 深度。正式接受行的 Δx/Δy/Δz/yaw 来自正式位姿；拒绝行没有正式位姿，表中改列出保存的诊断候选相对标定板的差距，并明确标记为 `rejected_candidate_diagnostic`。

## 汇总

|方法|深度|接受/拒绝运行|接受帧|拒绝帧|接受可评分帧|拒绝候选可评分帧|接受 Δx|接受 Δy|接受 Δz|接受 yaw|拒绝候选 Δx|拒绝候选 Δy|拒绝候选 Δz|拒绝候选 yaw|主耗时中位数 s|
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
|FDP|raw|65/0|13|0|11|0|3.415|0.145|-8.847|0.872|N/A|N/A|N/A|N/A|1.274|
|V5-original|lingbot|20/45|4|9|3|8|-5.512|-3.439|-2.044|0.414|3.815|-4.023|-14.363|0.712|21.406|
|BCM|lingbot|20/45|4|9|3|8|-5.512|-3.439|-2.044|0.414|3.815|-4.023|-14.363|0.712|21.193|
|R1|lingbot|15/50|3|10|3|8|-4.873|-1.321|-1.856|0.348|4.624|-3.462|-14.507|0.515|0.966|
|RM|lingbot|15/50|3|10|3|8|-5.512|-3.439|-2.044|0.348|3.815|-4.023|-14.363|0.649|5.293|
|R1F|lingbot|20/45|4|9|3|8|-4.873|-1.321|-1.856|0.348|3.815|-4.023|-14.363|0.712|22.186|
