...
知识库也已补充索引：[knowledge_base.md](../../assets/9532a89bcd51d69d--knowledge_base.md:273)。后续执行命令时，我会继续提前明确标注“本机 / S1 宿主机 / S1 容器内”。
...
更正后的调查报告在：[s1_navigation_sdk_report_20260827.md](../../assets/f6378b5bcdb04289--s1_navigation_sdk_report_20260827.md:54)。当前建议已经变为：**官方 SDK 学习脚本优先用宿主机 `s1-python`；依赖 ROS Noetic 或生产项目库时再使用容器。**
