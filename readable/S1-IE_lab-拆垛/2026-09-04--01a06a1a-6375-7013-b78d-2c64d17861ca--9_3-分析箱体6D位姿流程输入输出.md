...
- 更新时间：2026-09-04T15:58:32.758000+08:00
- 状态：活动
...
结论：你列出的顺序与 2026-09-03 对当前 S1 部署源码的只读审计一致，可以作为 `run_s1_mode00_one_click.py` 的 Mode 00 主流程图。[知识库中的源码审计记录](/home/lsy03/文档/ChatGPT/S1/docs/knowledge_base.md:839)
...
完整主链在知识库中的记录与你写的一致：[主链与关键限制](/home/lsy03/文档/ChatGPT/S1/docs/knowledge_base.md:844)。
...
这一实验明确停止在归一化后的 4317 物体位姿，不导入规划器、执行器或执行器接口，见 [FDP baseline 实验边界](/home/lsy03/文档/ChatGPT/S1/experiments/20260903_fdp_baseline/README.md:1)；完整生产链位置见 [Mode 00 主链审计](/home/lsy03/文档/ChatGPT/S1/docs/knowledge_base.md:844)。
