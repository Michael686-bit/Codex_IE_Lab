...
结论：你列出的顺序与 2026-09-03 对当前 S1 部署源码的只读审计一致，可以作为 `run_s1_mode00_one_click.py` 的 Mode 00 主流程图。[知识库中的源码审计记录](../../assets/9532a89bcd51d69d--knowledge_base.md:839)
...
完整主链在知识库中的记录与你写的一致：[主链与关键限制](../../assets/9532a89bcd51d69d--knowledge_base.md:844)。
...
这一实验明确停止在归一化后的 4317 物体位姿，不导入规划器、执行器或执行器接口，见 [FDP baseline 实验边界](../../assets/4e5683453ee99533--README.md:1)；完整生产链位置见 [Mode 00 主链审计](../../assets/9532a89bcd51d69d--knowledge_base.md:844)。
